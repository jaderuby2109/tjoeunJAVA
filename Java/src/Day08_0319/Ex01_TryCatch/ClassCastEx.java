...
public class ClassCastEx {
	...
	public static Dog changeToDog(Animal animal) {	// 매개변수를 받는 과정에서 업캐스팅
													// Animal animal = new Dog();

		Dog dog = null;
		// 예외 메세지	: java.lang.ClassCastException: class Cat cannot be cast to class Dog (Cat and Dog are in module Java of loader 'app')
