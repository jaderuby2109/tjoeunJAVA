package Day10_0321.Ex07_Format;
...
public class MessageFormatEx {
	...
	public static void main(String[] args) {
		...
		studentFormat = "이름 : {0} \n" + "학번 : {1} \n" + "전공 : {2} \n";
		student       = MessageFormat.format(studentFormat, studentInfo);
		System.out.println(student);
		...
		studentFormat = "이름 : {0} \n" + "학번 : {1} \n" + "전공 : {2} \n" + "나이 : {3} \n" + "나이 : {3} \n" + "나이 : {4} \n";
		student       = MessageFormat.format(studentFormat, studentInfo, "감자");
		System.out.println(student);

		studentFormat = "이름 : {0} \n" + "학번 : {1} \n" + "전공 : {2} \n" + "나이 : {3} \n" + "나이 : {4} \n" + "나이 : {5} \n";
		student       = MessageFormat.format(studentFormat, "감자", studentInfo);
		System.out.println(student);
