...
public class DateEx {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println("SimpleDateFormat\t: " + nowStr);
		...
		System.out.println("종강 D-day\t\t: " + gapDays + "일");
		System.out.println("종강까지 남은 시간(/시)\t: " + gapHours + "시");
		System.out.println("종강까지 남은 시간(/분)\t: " + gapMin + "분");
		System.out.println("종강까지 남은 시간(/초)\t: " + gapSec + "초");

		// * Date 객체의 getXXX() 메소드는 deprecated(더 이상 사용권장 안 함)
		// --> 날짜의 년/월/일 추출하는 기능은 Calendar 클래스를 주로 사용
		System.out.println("Today (년)\t\t: " + date1.getYear() + "년");
		System.out.println("Today (월)\t\t: " + date1.getMonth() + "월");
		System.out.println("Today (일)\t\t: " + date1.getDate() + "일");
