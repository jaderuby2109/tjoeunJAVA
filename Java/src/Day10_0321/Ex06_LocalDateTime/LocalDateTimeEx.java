package Day10_0321.Ex06_LocalDateTime;
...
public class LocalDateTimeEx {
	...
	public static void main(String[] args) {
		...
		// 2025년 3월 21일 4시 0분 0초
		LocalDateTime todayDateTime = LocalDateTime.of(2025, 3, 21, 4, 0, 0);
		System.out.println("오늘\t\t: " + todayDateTime);

		// 2025년 9월 16일 18시 30분 0초
		LocalDateTime endDateTime = LocalDateTime.of(2025, 9, 16, 18, 30, 0);
