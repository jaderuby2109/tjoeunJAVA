...
public class UserInfoTestUsingOptional {
	...
	public static void usingOptional(ArrayList<UserInfo> list) {
		...
		userInfoOptional.ifPresent(userInfo 
				-> System.out.println("User name found: " + userInfo.getName()));
		System.out.println();
